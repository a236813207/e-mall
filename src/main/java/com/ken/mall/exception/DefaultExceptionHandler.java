...
public class DefaultExceptionHandler {
    ...
    @ResponseBody
    public ResBody processBizException(NativeWebRequest request, BizException e) {
    ...
    @ResponseBody
    public ResBody processBindException(NativeWebRequest request, BindException e) {
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public ResBody processIllegalArgumentException(NativeWebRequest request, Exception e) {
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public ResBody processException(NativeWebRequest request, Throwable e) {
