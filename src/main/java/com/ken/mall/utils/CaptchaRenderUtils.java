 ...
 *
 */
public class CaptchaRenderUtils {
     ...
     */
    public CaptchaRenderUtils(int imgRandNumber) {
        if(imgRandNumber < 4) {
            imgRandNumber = 4;
        }
        this.imgWidth = 15*imgRandNumber;
        this.imgHeight = 24;
    ...
    public static boolean validate(String md5RandomCode, String inputRandomCode) {
        if (StringUtils.isEmpty(md5RandomCode) || StringUtils.isEmpty((inputRandomCode))) {
            return false;
        }
        try {
