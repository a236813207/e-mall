...
public class OSSManager {
    private static final String DIR = "e-mall/";
    ...
    public String putObject(String dir/*默认chaoshi/storage/*/, String bucketName, MultipartFile file) throws IOException, NoSuchAlgorithmException {
    ...
    public String putObject(String dir/*默认chaoshi/storage/*/, String bucketName, String imageData) throws IOException {
        if (StringUtils.isBlank(dir)) {
            dir = DIR;
        }
